...
const packageFilters = [
  ...
  ['packages/shadcn-auth/', '@pixpilot/shadcn-auth'],
  ['packages/shadcn-formily/', '@pixpilot/formily-shadcn'],
  ['packages/shadcn-ui/', '@pixpilot/shadcn-ui'],
  ['packages/shadcn/', '@pixpilot/shadcn'],

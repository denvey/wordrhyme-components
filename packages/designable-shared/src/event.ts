...
const ATTACHED_SYMBOL: symbol = Symbol('ATTACHED_SYMBOL');
const EVENTS_SYMBOL: symbol = Symbol('__EVENTS_SYMBOL__');
const EVENTS_ONCE_SYMBOL: symbol = Symbol('EVENTS_ONCE_SYMBOL');
const EVENTS_BATCH_SYMBOL: symbol = Symbol('EVENTS_BATCH_SYMBOL');
const DRIVER_INSTANCES_SYMBOL: symbol = Symbol('DRIVER_INSTANCES_SYMBOL');

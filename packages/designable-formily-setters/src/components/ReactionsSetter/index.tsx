...
import { GlobalRegistry } from '@wordrhyme/designable-core';
import { requestIdle } from '@wordrhyme/designable-shared';
import { usePrefix, TextWidget } from '@wordrhyme/designable-react';
import { MonacoInput } from '@wordrhyme/designable-react-settings-form';
                            ...
                            x-reactions={(field) => {
                              ...
                              field.query('.source').take((source) => {
                                ...
                                if (source.value && !field.value && !field.modified) {
                                  field.value =
                                    source.inputValues[1]?.props?.name || `v_${uid()}`;
                                }
                              });
                            }}
                          />

...
import { z } from 'zod';
import type { CreateFormSchemaOptions, FieldType, ParsedZodField } from './types';
...
export function createFormSchema<T extends z.ZodObject<z.ZodRawShape>>(
  ...
  for (const [key, fieldSchema] of Object.entries(shape)) {
    ...
    const component =
      inferredByName?.component ?? fieldTypeToFormilyComponent[parsed.type];
    ...
    properties[key] = {
      ...
      'x-component-props': {
        ...getComponentProps(parsed.type, parsed),
        ...inferredProps,
      },
      ...(parsed.enumValues && {

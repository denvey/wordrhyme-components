...
import { TreeNode, CursorStatus, CursorDragType } from '@wordrhyme/designable-core';
import { IRect, LayoutObserver } from '@wordrhyme/designable-shared';
import { useViewport } from './useViewport';
import { useDesigner } from './useDesigner';

const isEqualRect = (rect1?: IRect, rect2?: IRect) => {
  return (
    rect1?.x === rect2?.x &&
    rect1?.y === rect2?.y &&
